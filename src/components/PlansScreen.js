...
import { collection, where, query, getDocs, addDoc, doc, onSnapshot } from 'firebase/firestore';
        ...
        getDocs(q).then(querySnapshot => {
            ...
            querySnapshot.forEach(async productDoc => {
                try {
                    ...
                    const priceSnapComplete = await getDocs(priceSnap)

                    // there an be more than one price , therefore go through the prices 
                    priceSnapComplete.docs.forEach(price => {
